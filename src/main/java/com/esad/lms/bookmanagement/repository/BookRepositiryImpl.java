...
public class BookRepositiryImpl implements BookRepository {
	...
	public void insertBook(Books book) {
        ...
        SqlParameterSource param = new MapSqlParameterSource()
        		...
        		.addValue("rackNo", book.getRackNo())
        		.addValue("status", book.getStatus())
        		.addValue("issuedTo", book.getIssuedTo())
        		.addValue("dateOfissued", book.getDateOfIssued())
        		.addValue("dateOfPurchase", book.getDateOfPurchase())
